...
double kT[TempPoints] = {0.02, 0.04, 0.06, 0.08, 0.10, 0.12, 0.14, 0.16, 0.161, 0.162, 0.163, 0.164, 0.165, 0.166, 0.167, 0.168, 0.169, 0.17, 0.171, 0.172, 0.173, 0.174, 0.175, 0.176, 0.177, 0.178, 0.179, 0.18, 0.20, 0.22, 0.24, 0.26, 0.28, 0.30, 0.32, 0.34, 0.36, 0.38, 0.40};
short neighbors[2];
...
int main ()
{
	ofstream opfile, opfile2;
  	opfile.open ("Toom10h0.ods");
  	opfile2.open ("Toom10h0evolve.ods");
